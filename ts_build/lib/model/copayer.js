...
var Copayer = (function () {
    ...
    Copayer.create = function (opts) {
        ...
        if (addressmanager_1.AddressManager.supportsCopayerBranches(derivationStrategy)) {
            x.addressManager = addressmanager_1.AddressManager.fromObj({
    ...
    Copayer.prototype.createAddress = function (wallet, isChange) {
        ...
        var address = address_1.Address.derive(wallet.id, wallet.addressType, wallet.publicKeyRing, path, wallet.m, wallet.coin, wallet.network, isChange);
        return address;
    };
    return Copayer;
}());
exports.Copayer = Copayer;
//# sourceMappingURL=copayer.js.map