...
var BtcChain = (function () {
    ...
    BtcChain.prototype.getEstimatedSizeForSingleInput = function (txp) {
    ...
    BtcChain.prototype.getEstimatedSize = function (txp) {
        var _this = this;
    ...
    BtcChain.prototype.getEstimatedFee = function (txp) {
    ...
    BtcChain.prototype.checkTx = function (txp) {
        ...
        if (bitcoreError instanceof this.bitcoreLib.errors.Transaction.FeeError)
            return new clienterror_1.ClientError(Errors.codes.INSUFFICIENT_FUNDS_FOR_FEE, Errors.INSUFFICIENT_FUNDS_FOR_FEE.message + ' + coin: ' + txp.coin + ' feePerKb: ' + txp.feePerKb);
        ...
        var select = function (utxos, coin, cb) {
            ...
            if (netValueInUtxos < txpAmount) {
                logger_1.default.debug('Value after fees in all utxos (' +
                    ...
                    Utils.formatAmountInBtc(txpAmount) +
                    ')');
                return cb(new clienterror_1.ClientError(Errors.codes.INSUFFICIENT_FUNDS_FOR_FEE, Errors.INSUFFICIENT_FUNDS_FOR_FEE.message + ' + coin: ' + txp.coin + ' feePerKb: ' + txp.feePerKb));
            }
            ...
            if (lodash_1.default.isEmpty(selected)) {
                return cb(error ||
                    new clienterror_1.ClientError(Errors.codes.INSUFFICIENT_FUNDS_FOR_FEE, Errors.INSUFFICIENT_FUNDS_FOR_FEE.message + ' + coin: ' + txp.coin + ' feePerKb: ' + txp.feePerKb));
            }
